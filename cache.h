...
// Contract:
// - cache, existed, evicted, evicted_ip and evicted_value must be valid
//   non-NULL pointers.
...
// Contract:
// - cache, existed and existed_value must be valid non-NULL pointers.
...
// is not contant.
// Contract:
// - cache and value must be valid non-NULL pointers.
...
// Contract:
// - cache, ips and ips_len must be valid non-NULL pointers.
